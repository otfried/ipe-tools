...
Build-Depends: sharutils, doxygen, debhelper (>= 9~), zlib1g-dev, qtbase5-dev, qtbase5-dev-tools, libfreetype6-dev, libcairo2-dev, libjpeg-dev, libpng-dev, liblua5.3-dev, libgsl-dev, libspiro-dev, libcurl4-openssl-dev, libfontconfig1-dev, libqtspell-qt5-dev
Files:
EOF
